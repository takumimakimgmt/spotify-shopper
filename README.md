...
- Filters single-source-of-truth: `useFiltersState` owns `categoryFilter`, `searchQuery`, `sortKey`. Derived track lists and counts computed via `lib/ui/selectors.ts`.
